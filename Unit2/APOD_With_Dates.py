...
def fetch_apod(base_url, api_key, date_to_search):
    ...
    url = base_url + api_key + date_to_search
    print(url)
...
api_key = "bwhfRfckxcDnGmhLfQF1zCDyXIhe23wHoiiExGz2"
date_to_search = input() #Finish this code
apod_data = fetch_apod(base_url , api_key , date_to_search)#finish this code)
