...
while True:
    print("Would you like to view list or delete list?")
    print_choice = input("type 'view' to view or type 'delete' to delete ")
    #if they select 'view'
    if print_choice == "view":
        #print the contents of the array
        print(fridgeContents)
        #break out of the loop
        break
    #if they select 'delete'
    elif print_choice == "delete":
